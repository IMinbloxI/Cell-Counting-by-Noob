...
axes[0][0].axis('off')
cv.imwrite("results/1_original.png", img_bgr)

axes[0][1].imshow(grey_img,cmap = 'gray')
axes[0][1].set_title("Grayscale")
axes[0][1].axis('off')
cv.imwrite("results/2_grey.png", grey_img)

axes[1][0].imshow(threshold,cmap = 'gray')
axes[1][0].set_title("Threshold")
axes[1][0].axis('off')
cv.imwrite("results/3_Threshold.png", threshold)
...
axes[1][1].axis('off')
cv.imwrite("results/4_result.png", result_img)
plt.tight_layout(pad=0.5)
plt.savefig("results/cell_count_plot.png", dpi=300, bbox_inches="tight")
plt.show()
